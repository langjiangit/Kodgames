...
public class SSConnectionHandler extends AbstractConnectionHandler
{
    ...
    {
	    logger.info("ManagerServer active. Server Address:{}", connection.getNettyNode().getAddress());
    ...
    {
		logger.info("ManagerServer inactive. Server Address:{}", connection.getNettyNode().getAddress());
