...
public final class SubCard extends limax.zdb.XBean {
    private String gmAdmin; 
    private int count; 
    private String reason; 
    private long time; 

    SubCard(limax.zdb.XBean _xp_, String _vn_) {
        super(_xp_, _vn_);
        gmAdmin = "";
        reason = "";
	}
	...
	public SubCard(SubCard _o_) {
		this(_o_, null, null);
	}

	SubCard(SubCard _o_, limax.zdb.XBean _xp_, String _vn_) {
		super(_xp_, _vn_);
		_o_.verifyStandaloneOrLockHeld("_o_.SubCard", true);
        this.gmAdmin = _o_.gmAdmin;
        this.count = _o_.count;
        this.reason = _o_.reason;
        this.time = _o_.time;
	}

	public void copyFrom(SubCard _o_) {
		_o_.verifyStandaloneOrLockHeld("copyFromSubCard", true);
		this.verifyStandaloneOrLockHeld("copyToSubCard", false);
        limax.zdb.Logs.logObject(this, "gmAdmin");
        this.gmAdmin = _o_.gmAdmin;
        limax.zdb.Logs.logObject(this, "count");
        this.count = _o_.count;
        limax.zdb.Logs.logObject(this, "reason");
        this.reason = _o_.reason;
	...
	public final OctetsStream unmarshal(OctetsStream _os_) throws MarshalException {
		...
		this.reason = _os_.unmarshal_String();
	...
	public String getReason() { 
		this.verifyStandaloneOrLockHeld("getReason", true);
		return this.reason;
	}
	...
	public void setReason(String _v_) { 
		this.verifyStandaloneOrLockHeld("setReason", false);
		java.util.Objects.requireNonNull(_v_);
		limax.zdb.Logs.logObject(this, "reason");
		this.reason = _v_;
	}
	...
	public final boolean equals(Object _o1_) {
		...
		SubCard _o_ = null;
		if ( _o1_ instanceof SubCard ) _o_ = (SubCard)_o1_;
		else return false;
		if (!this.gmAdmin.equals(_o_.gmAdmin)) return false;
		if (this.count != _o_.count) return false;
		if (!this.reason.equals(_o_.reason)) return false;
	...
	public int hashCode() {
		...
		_h_ += _h_ * 31 + this.reason.hashCode();
	...
	public String toString() {
		...
		_sb_.append("T").append(this.reason.length()).append(",");
