...
public class SSExchangePeerInfoSYNCAction extends ProtobufMessageHandler<ServerService, ServerProtoBuf.SSExchangePeerInfoSYNC>
{
	...
	{
		logger.info("Exchange peer Info, remote peer id:{}", message.getServerID());
		...
		{
			ServiceContainer.getInstance().getPublicService(ServerService.class).setGameConnection(connection);
		}
	}
}
