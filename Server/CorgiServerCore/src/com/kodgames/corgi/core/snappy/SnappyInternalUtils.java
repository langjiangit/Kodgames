...
final class SnappyInternalUtils
{
    ...
    static {
        ...
        if (memoryInstance == null) {
            try {
                Class<? extends Memory> slowMemoryClass = SnappyInternalUtils.class.getClassLoader().loadClass("com.kodgames.corgi.core.snappy.SlowMemory").asSubclass(Memory.class);
                ...
                throw new AssertionError("Could not find com.kodgames.corgi.core.snappy.SlowMemory class");
            }
        }
