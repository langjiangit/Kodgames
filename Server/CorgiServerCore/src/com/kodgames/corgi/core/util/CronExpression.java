...
public class CronExpression implements Serializable, Cloneable {
    ...
    public int getMinute(){
    	String minute = getExpressionSetSummary(minutes);
    	if(minute.equals("*"))
    		return -1;
    	else
    		return StrUtils.parseInt(minute,-1);
    }
    
    public int getHour(){
    	String hour = getExpressionSetSummary(hours);
    	if(hour.equals("*"))
    		return -1;
    	else	
    		return StrUtils.parseInt(hour,-1);
    }
    
    public int getDayOfMonth(){
    	String dayOfMonth = getExpressionSetSummary(daysOfMonth);
    	if(dayOfMonth.equals("*"))
    		return -1;
    	else
    		return StrUtils.parseInt(dayOfMonth,-1);
    }
    
    public int getMonth(){
    	String month = getExpressionSetSummary(months);
    	if(month.equals("*"))
    		return -1;
    	else
    		return StrUtils.parseInt(month,-1);
    }
    
    public int getDayOfWeek(){
    	String dayOfWeek = getExpressionSetSummary(daysOfWeek);
    	if(dayOfWeek.equals("?"))
    		return -1;
    	else
    		return StrUtils.parseInt(dayOfWeek,-1);
    }        
}
