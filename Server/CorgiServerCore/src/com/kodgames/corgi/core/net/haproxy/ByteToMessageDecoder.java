 ...
 * <p>
 * <pre>
 *     public class SquareDecoder extends {@link io.netty.handler.codec.ByteToMessageDecoder} {
 *         {@code @Override}
 ...
 * one with {@link io.netty.handler.codec.ByteToMessageDecoder}. Ensure there are enough bytes in the buffer for a
 ...
 * <h3>Pitfalls</h3>
 * <p>
 * Be aware that sub-classes of {@link io.netty.handler.codec.ByteToMessageDecoder} <strong>MUST NOT</strong>
...
public abstract class ByteToMessageDecoder extends ChannelInboundHandlerAdapter {
     ...
     */
    public static final io.netty.handler.codec.ByteToMessageDecoder.Cumulator MERGE_CUMULATOR = new io.netty.handler.codec.ByteToMessageDecoder.Cumulator() {
        @Override
    ...
    ByteBuf cumulation;
    private io.netty.handler.codec.ByteToMessageDecoder.Cumulator cumulator = MERGE_CUMULATOR;
     ...
     */
    public void setCumulator(io.netty.handler.codec.ByteToMessageDecoder.Cumulator cumulator) {
        if (cumulator == null) {
