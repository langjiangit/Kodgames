...
public final class HAProxyMessage {
    ...
    static HAProxyMessage decodeHeaderNull(HAProxyProtocolVersion version) {
        return new HAProxyMessage(version, HAProxyCommand.PROXY, HAProxyProxiedProtocol.UNKNOWN, null, null, 0, 0);
    }
